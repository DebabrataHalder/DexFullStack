...
function Swap(props) {
  ...
  async function fetchPrices(one, two){
    ...
    const res = await axios.get(`https://vast-jade-buffalo-fez.cyclic.app/tokenPrice`, {
...
async function fetchDexSwap(){
  ...
  if(allowance.data.allowance === "0"){
    ...
    // console.log(tokenOne.decimals);
    // console.log(tokenOneAmount.length);
    // console.log('wassuppp',tokenOneAmount.padEnd(tokenOne.decimals+tokenOneAmount.length, '0'))
    return
